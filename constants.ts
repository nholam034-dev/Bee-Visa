...
export const COUNTRIES_SUMMARY: CountrySummary[] = [
  { id: "usa", name: "Mỹ", badge: "Hot", description: "Visa 1 năm, phỏng vấn trực tiếp", image: "/images/destinations/my.png" },
  { id: "uk", name: "Anh Quốc", badge: "Phổ biến", description: "Visa 6 tháng, 2/5/10 năm", image: "/images/destinations/anh-quoc.png" },
  { id: "schengen", name: "Châu Âu", badge: "Cao cấp", description: "29 nước khối Schengen", image: "/images/destinations/chau-au.png" },
  { id: "australia", name: "Úc", badge: "E-Visa", description: "Nộp online, visa 1-3 năm", image: "/images/destinations/uc.png" },
  { id: "canada", name: "Canada", badge: "10 Năm", description: "Visa theo hạn hộ chiếu", image: "/images/destinations/canada.png" },
  { id: "newzealand", name: "New Zealand", badge: "Online", description: "Visa điện tử tiện lợi", image: "/images/destinations/new-zealand.png" },
  { id: "japan", name: "Nhật Bản", badge: "Nhanh", description: "E-visa đoàn hoặc dán", image: "/images/destinations/nhat-ban.png" },
  { id: "korea", name: "Hàn Quốc", badge: "Trend", description: "Đại đô thị & 5 năm", image: "/images/destinations/han-quoc.png" },
  { id: "china", name: "Trung Quốc", badge: "Dễ", description: "Visa đoàn & thương mại", image: "/images/destinations/trung-quoc.png" },
  { id: "hongkong", name: "Hong Kong", badge: "E-Visa", description: "Visa điện tử 100%", image: "/images/destinations/hong-kong.png" },
  { id: "taiwan", name: "Đài Loan", badge: "Miễn phí", description: "Có điều kiện miễn thị thực", image: "/images/destinations/dai-loan.png" },
  { id: "uae", name: "Dubai (UAE)", badge: "24h", description: "Visa điện tử nhanh gọn", image: "/images/destinations/dubai.png" },
  { id: "russia", name: "Nga", badge: "E-Visa", description: "Visa điện tử 16 ngày", image: "/images/destinations/nga.png" },
  { id: "southafrica", name: "Nam Phi", badge: "Safari", description: "Nộp tại ĐSQ/LSQ", image: "/images/destinations/nam-phi.png" },
  { id: "india", name: "Ấn Độ", badge: "E-Visa", description: "Visa 1 năm/5 năm online", image: "/images/destinations/an-do.png" },
  { id: "egypt", name: "Ai Cập", badge: "Kỳ quan", description: "Visa dán hoặc E-visa", image: "/images/destinations/ai-cap.png" },
];
